...
export const getInventoryByBarcode = async (req, res) => {
  try {
    ...
    const inventory =
      await inventoryService.getInventoryByBarcodeService(
        barcode,
        Number(storeId)
      );
...
export const getInventoryByTag = async (req, res) => {
  try {
    ...
    const inventory =
      await inventoryService.getInventoryByTagService(
        tag,
        Number(storeId)
      );
    ...
    console.error("Get inventory by tag error:", error);
